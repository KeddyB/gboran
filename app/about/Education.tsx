...
export default function Education (){
    return (
        <div className="dark:text-gray-200 p-8 border-b-2" id='education'>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            />
              ...
              <h3 className="text-xl font-bold mt-3 mb-2">Effects</h3>
              ...
              <div className="bg-gray-100 dark:bg-gray-700 p-4 mb-6 rounded-lg mt-5">
                <ul className="list-disc list-inside space-y-2 dark:text-gray-200">
            ...
            <div>
              ...
              <h3 className="text-lg font-bold mt-3 mb-2">PUBLIC SERVICE/PRIVATE SECTOR </h3>
              <p className="text-justify">
