            ...
            <div>
              ...
              <ul>
                <li className="mb-4 text-justify">
                  <h1 className="font-bold mb-2">a. THE OLUNHUNDOLE</h1>
                  <p>
                  ...
                  <Image 
                    ...
                    width={600} 
                    height={200}
                    className="mb-4 mx-auto mt-4 rounded-sm"
                  />
                  <p>
                ...
                <li className="mb-4">
                  <h1 className="font-bold">b. Bata</h1>
                  <p>
                ...
                <li className="mb-4">
                  <h1 className="font-bold">c. Oro Eegun</h1>
                  <ol>
                    <li>i. Abodogen</li>
                    <li>ii. Alagada</li>
                ...
                <li><h1 className="font-bold">d. Ogbele</h1>for young female up to 20 years of age.</li>
                <li><h1 className="font-bold">e. Odun Omi</h1> for young female to marriage age - Usually to know who are still Virgins.</li>
                <li><h1 className="font-bold">f. Odun Ogun</h1></li>
              </ul>
            </div>
          </div>
        </div>
